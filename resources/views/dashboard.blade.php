            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <ul class="nav">
                      ...
                      <li class="scroll-to-section"><a href="#events">LogIn</a></li>
      ...
      <div class="row">
        <div class="col-lg-4 col-md-6">
          <div class="service-item">
            ...
            <div class="main-content">
              <h4>Service 1</h4>
              <p>Whenever you need free servive 1, you just remember our website.</p>
              <div class="main-button">
                <a href="#">Subcribe</a>
              </div>
            </div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="service-item">
            ...
            <div class="main-content">
              <h4>Service 3</h4>
              <p>You can browse free services based on different tags such as appointments, etc.</p>
              <div class="main-button">
                <a href="#">Subscribe</a>
              </div>
            </div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="service-item">
            ...
            <div class="main-content">
              <h4>Service 3</h4>
              <p>You can start enjoying events by modifying your from our website too.</p>
              <div class="main-button">
                <a href="#">Subscribe</a>
              </div>
            </div>
